...
<Questions>
    ...
    <Q>
        ...
        <A>
            ...
            * [ProtocolSupport](https://www.spigotmc.org/resources/7201/) ~~is currently incompatible with Floodgate.~~ Works with Floodgate, but we recommend using [ViaBackwards](https://hangar.papermc.io/ViaVersion/ViaBackwards) instead. it's also has a version(mcpenew branch) that is intended to do the same what GeyserMC does. 
            * [ProtocolSupportBungee](https://www.spigotmc.org/resources/8733/) changes how the login process works and therefore breaks the Floodgate injection code. it does the same thing with GeyserMC if the mcpenew branch is installed either.
